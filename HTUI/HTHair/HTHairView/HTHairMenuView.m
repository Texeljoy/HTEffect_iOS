...
#import "HTHairMenuViewCell.h"
#import "HTUIConfig.h"

@interface HTHairMenuView ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) NSArray *listArr;

@end

static NSString *const HTHairMenuViewCellId = @"HTHairMenuViewCellId";

@implementation HTHairMenuView
...
- (UICollectionView *)menuCollectionView{
    if (!_menuCollectionView) {
        ...
        [_menuCollectionView registerClass:[HTHairMenuViewCell class] forCellWithReuseIdentifier:HTHairMenuViewCellId];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HTHairMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:HTHairMenuViewCellId forIndexPath:indexPath];
