...
#import "HTBodyMenuViewCell.h"
#import "HTUIConfig.h"

@interface HTBodyMenuView ()<UICollectionViewDataSource,UICollectionViewDelegate>

@property (nonatomic, strong) NSArray *listArr;

@end

static NSString *const HTBodyMenuViewCellId = @"HTBodyMenuViewCellId";

@implementation HTBodyMenuView
...
- (UICollectionView *)menuCollectionView{
    if (!_menuCollectionView) {
        ...
        [_menuCollectionView registerClass:[HTBodyMenuViewCell class] forCellWithReuseIdentifier:HTBodyMenuViewCellId];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HTBodyMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:HTBodyMenuViewCellId forIndexPath:indexPath];
