...
@interface HTFilterMenuView ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
@implementation HTFilterMenuView
...
- (UICollectionView *)menuCollectionView{
    if (!_menuCollectionView) {
        ...
        [_menuCollectionView registerClass:[HTSubMenuViewCell class] forCellWithReuseIdentifier:HTFilterMenuViewCellId];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    HTSubMenuViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:HTFilterMenuViewCellId forIndexPath:indexPath];
    if (self.selectedIndexPath.row == indexPath.row) {
        [cell setTitle:dic[@"name"] selected:YES textColor:MAIN_COLOR];
    }else{
        [cell setTitle:dic[@"name"] selected:NO textColor:self.isThemeWhite ? [UIColor blackColor] : HTColors(255, 0.6)];
    }
